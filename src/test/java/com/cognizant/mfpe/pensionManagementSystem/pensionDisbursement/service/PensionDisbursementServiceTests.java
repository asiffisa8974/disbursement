...
public class PensionDisbursementServiceTests {
	...
	ProcessPensionInput processPensionInput1 = new ProcessPensionInput(1234567891011121L, 6069.98, 550.0);
	ProcessPensionInput processPensionInput2 = new ProcessPensionInput(12345678910120L, 60.0, 550.0);
	ProcessPensionInput processPensionInput3 = new ProcessPensionInput(12345678910120L, 6000.0, 550.0);
	ProcessPensionInput processPensionInput4 = new ProcessPensionInput(1234567891011120L, 6069.98, 500.0);
	ProcessPensionInput processPensionInput5 = new ProcessPensionInput(123456789101112000L, 6069.98, 550.0);
	ProcessPensionInput processPensionInput6 = new ProcessPensionInput(12345678910111L, 6069.98, 550.0);
